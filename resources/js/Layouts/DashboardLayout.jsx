...
export default function DashboardLayout() {
    ...
    if (!data) return <div className="min-h-screen bg-gray-50 flex items-center justify-center text-gray-500 font-bold">Loading System...</div>;
    ...
    const SidebarLink = ({ path, icon, text }) => {
        ...
        return (
            <div 
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer mb-1 ${isActive ? 'bg-purple-50 text-purple-700 font-bold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-medium'}`}
            >
