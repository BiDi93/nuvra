...
const S = {
    ...
    navActiveLine: { position: "absolute", left: 0, top: 0, bottom: 0, width: 3, background: "linear-gradient(180deg, #00ff87, #00c9ff)", borderRadius: "0 2px 2px 0" },
    ...
    statChipNum: { fontFamily: "'Barlow Condensed', sans-serif", fontSize: 24, color: "#00c9ff", lineHeight: 1 },
    ...
    cardAccent: { width: 3, background: "linear-gradient(180deg, #00c9ff, #a78bfa)", flexShrink: 0 },
    ...
    datePill: { fontSize: 10, fontWeight: 700, color: "#00c9ff", background: "rgba(0,201,255,0.08)", padding: "3px 8px", borderRadius: 4, letterSpacing: 0.5 },
